<template>
  <v-app>
    ...
    <v-toolbar app
      ...
      <v-toolbar-title>
        <router-link class="pointer"
                     tag="span"
                     to="/">Ad app</router-link>
      </v-toolbar-title>
      <v-spacer></v-spacer>
    ...
    <!-- Это компонент для вывода ошибок -->
    <template v-if="error">
...
export default {
  ...
  data() {
    return {
      drawer: false
      // переписали links в computed, содержание массива теперь зависит от isUserLoggedIn
      // links: [
      //   {
      //     title: "Login",
      //     icon: "lock",
